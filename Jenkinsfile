        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    git branch: 'master', url: 'https://github.com/kireobat/oauth-app.git'
                }
            }
        }
        stage('Build') {
            ...
            steps {
                script {
                    ...
                    docker.withRegistry('https://index.docker.io/v1/', 'dockerhub') {
                        def app = docker.build("kireobat/oauth-app")
                    ...
                    script {
                        ...
                        def createContainer = { token, name, hostPort ->
                            ...
                            def deployResponse = httpRequest(
                                ...
                                customHeaders: [[name: 'Authorization', value: "Bearer ${token}"]],
                                requestBody: """{
                                    "Image": "kireobat/oauth-app:latest",
                                    "HostConfig": {
                                        "PortBindings": {
